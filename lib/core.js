...
//				rdfaContext.newSubject = base.toString();
	...
	if(typeof setProperty=='string'){
		...
		}else if(datatypeIRI && setDatatype){
			if(self.XMLSerializer && datatypeIRI.equals(XMLLiteralURI)){
				...
				currentPropertyValue = rdfaContext.rdfenv.createLiteral(xmlData, datatypeIRI);
			}else{
